# Auth Service Node.js Package Documentation

This document provides a detailed breakdown of the `package.json` configuration, dependencies, and development tools used in the **auth-service** microservice.
...
| :--- | :--- | :--- |
| **Name** | `auth-service` | The official name of this microservice. |
| **Version** | `1.0.0` | The current semantic version of the auth service. |
