# LEMF Service Node.js Package Documentation

This document provides a detailed breakdown of the `package.json` configuration, dependencies, and development tools used in the **lemf-service** microservice.
...
| :--- | :--- | :--- |
| **Name** | `lemf-service` | The official name of this microservice. |
| **Version** | `1.0.0` | The current semantic version of the lemf service. |
